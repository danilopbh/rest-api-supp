 ...
 */
final class Version20241017185640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE certidao_divida_siatu (id INT NOT NULL, contribuinte_siatu_id INT NOT NULL, valor DOUBLE PRECISION NOT NULL, pdfdivida BYTEA NOT NULL, descricao VARCHAR(255) NOT NULL, data_vencimento DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_36C56A914D6ED255 ON certidao_divida_siatu (contribuinte_siatu_id)');
        $this->addSql('CREATE TABLE certidao_divida_supp (id INT NOT NULL, contribuinte_supp_id INT DEFAULT NULL, valor DOUBLE PRECISION NOT NULL, pdfdivida BYTEA NOT NULL, descricao VARCHAR(255) NOT NULL, data_vencimento DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE contribuinte_supp (id INT NOT NULL, nome VARCHAR(255) NOT NULL, cpf VARCHAR(25) NOT NULL, endereco VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
